...
export const WaitlistHero = () => {
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center overflow-hidden" style={{ backgroundColor: colors.baseBg }}>
      {/* Animation Styles */}
      <style>{`
        @keyframes spin-slow {
          ...
          <div className="absolute inset-0 animate-spin-slow">
            ...
            >
              <img
                ...
                alt="Decorative"
                className="w-full h-full object-cover opacity-80 rounded-[4rem]"
              />
            </div>
          </div>
        </div>
